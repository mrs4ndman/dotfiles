...
export GPG_TTY=$(tty)
export ALTED="vim"
export PATH="$HOME/.console-ninja/.bin:$HOME/.cargo/bin:$HOME/.fzf/bin:$HOME/.local/bin:$HOME/.local/scripts:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games"
