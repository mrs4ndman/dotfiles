...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(ev)
    ...
    vim.keymap.set("n", "<leader>tD", require("telescope.builtin").lsp_document_symbols, { desc = "Document LSP symbols"})
    vim.keymap.set("n", "<leader>tW", require("telescope.builtin").lsp_dynamic_workspace_symbols, { desc = "Document LSP symbols"})
